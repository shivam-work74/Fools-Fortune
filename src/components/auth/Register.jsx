            ...
            >
                <div className="bg-[var(--bg-glass)] border border-[var(--border-primary)] rounded-[40px] p-12 shadow-[var(--shadow-premium)] backdrop-blur-xl relative overflow-hidden">
                    ...
                    <div className="text-center mb-10">
                        ...
                        <h2 className="text-3xl font-black text-gold tracking-tight uppercase">New Membership</h2>
                        <p className="text-[var(--text-muted)] text-[10px] mt-2 font-sans tracking-[0.3em] uppercase">Join the Inner Circle</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="relative group">
                            <label className={`absolute left-0 transition-all duration-300 pointer-events-none font-sans text-xs uppercase tracking-widest ${focusedField === 'username' || username ? '-top-5 text-yellow-600' : 'top-2 text-[var(--text-muted)]'}`}>
                                Alias
                            </label>
                            <input
                                type="text"
                        ...
                        <div className="relative group">
                            <label className={`absolute left-0 transition-all duration-300 pointer-events-none font-sans text-xs uppercase tracking-widest ${focusedField === 'password' || password ? '-top-5 text-yellow-600' : 'top-2 text-[var(--text-muted)]'}`}>
                                Password
                            </label>
                            <input
                                type="password"
                    ...
                    <div className="mt-8 text-center text-sm">
                        <span className="text-[var(--text-muted)] font-sans">Already a member? </span>
                        <Link to="/login" className="text-yellow-600 hover:text-yellow-500 font-bold uppercase tracking-wider ml-2 underline decoration-yellow-500/30 hover:decoration-yellow-500">
                            Present Credentials
                        </Link>
                    </div>
                </div>
